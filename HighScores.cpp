...
HighScores::HighScores() {
	...
	/// Busca los jugadores que necesitan ser reemplazados
	...
	if(cant==1){   /// (El jugador ya esta en la lista)
	...
	if(cant==0){   /// (El  jugador no esta en la lista)
		auto it = prev(Scores.end());
		if (comparing_score(jugador,*it)){   /// Comparamos el puntaje del nuevo jugador con el menor de la lista
